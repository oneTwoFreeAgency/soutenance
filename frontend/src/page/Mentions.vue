<template>
  <b-container>
    ...
    <p>
      ...
      site
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a>
      l'identité des différents intervenants dans le cadre de sa réalisation et
      de son suivi :
    </p>
    <p>
      <strong>Propriétaire</strong> : .oneTwoFree.com – – 10 rue du Terrage,
      75010 Paris<br />
      <strong>Créateur</strong> :
      <a target="blank" href="www.onetwofreeagency.com">.oneTwoFree.com</a
      ><br />
      <strong>Responsable publication</strong> : Binetou GUEYE & Michel MERLIN –
      binetou.gueye@colombbus.org<br />
      Le responsable publication est une personne physique ou une personne
      morale.<br />
      <strong>Webmaster</strong> : Raphaël TOMIC & Philippe MARIOU –
      raphael.tomic@colombbus.org<br />
      <strong>Hébergeur</strong> : SA ONETWOFREE – 10 rue du Terrage, 75010
      PARIS<br />
      Crédits : Binetou GUEYE Michel MERLIN Raphaël TOMIC Philippe MARIOU<br />
    ...
    <p>
      ...
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> sont
    ...
    <p>
      ...
      décidée par .oneTwoFree.com, qui s’efforcera alors de communiquer
      préalablement aux utilisateurs les dates et heures de l’intervention.
    </p>
    <p>
      Le site
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> est mis
      à jour régulièrement par Binetou GUEYE & Michel MERLIN. De la même façon,
      les mentions légales peuvent être modifiées à tout moment : elles
      s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus
      souvent possible afin d’en prendre connaissance.
    </p>
    <h3>3. Description des services fournis.</h3>
    <p>
      Le site
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> a pour
      objet de fournir une information concernant l’ensemble des activités de la
      société.
    </p>
    <p>
      .oneTwoFree.com s’efforce de fournir sur le site
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> des
    ...
    <p>
      ...
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> ne sont
    ...
    <p>
      .oneTwoFree.com est propriétaire des droits de propriété intellectuelle ou
    ...
    <p>
      .oneTwoFree.com ne pourra être tenue responsable des dommages directs et
      indirects causés au matériel de l’utilisateur, lors de l’accès au site
      www.onetwofreeagency.com, et résultant soit de l’utilisation d’un matériel
      ne répondant pas aux spécifications indiquées au point 4, soit de
      l’apparition d’un bug ou d’une incompatibilité.
    </p>
    <p>
      .oneTwoFree.com ne pourra également être tenue responsable des dommages
    ...
    <p>
      ...
      contact) sont à la disposition des utilisateurs. .oneTwoFree.com se
      ...
      protection des données. Le cas échéant, .oneTwoFree.com se réserve
    ...
    <p>
      ...
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a>, le
      fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP)
      de l'utilisateur.
    </p>
    <p>
      En tout état de cause .oneTwoFree.com ne collecte des informations
    ...
    <p>
      ...
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> n'est
      ...
      .oneTwoFree.com et de ses droits permettrait la transmission des dites
    ...
    <p>
      ...
      en place avec l’autorisation de .oneTwoFree.com. Cependant,
      .oneTwoFree.com n’a pas la possibilité de vérifier le contenu des sites
      ainsi visités, et n’assumera en conséquence aucune responsabilité de ce
      fait.
    </p>
    <p>
      La navigation sur le site
      <a href="//www.onetwofreeagency.com/">www.onetwofreeagency.com</a> est
